...
<head>
    ...
    {{-- <script src="{{ asset('js/jquery-3.6.1.js') }}" defer></script> --}}
    <!-- jquery cdn -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            {{-- This will display the nav bar options for admin acounts --}}
                            @if (Auth::user()->account_type == 0)
                                @include('pages.admin.nav-bar')
                            @endif
                            {{-- This will return the nav bar options of Employess --}}
                            @if (Auth::user()->account_type  == 1)
                                @include('pages.employee.nav-bar')
                            @endif
                            {{-- This will return the nav bar options of Drivers --}}
                            @if (Auth::user()->account_type  == 2)
                                @include('pages.driver.nav-bar')
                            @endif
