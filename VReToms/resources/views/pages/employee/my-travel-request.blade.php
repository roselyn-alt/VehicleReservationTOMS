                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="color-purple">
                            <strong>My Travel Request</strong>
                        </h4>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="nav-item dropdown">
                                            @if (($item->status != 0))
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="{{ route('employee-arrive-travel', ['id' => $item->id ]) }}" class="dropdown-item text-success">
                                                        &nbsp; <strong>Accomplished</strong>
                                                    </a>
                                                    <a href="{{ route('employee-cancel-travel', ['id' => $item->id ]) }}" class="dropdown-item text-danger">
                                                        &nbsp; <strong>Cancel</strong>
                                                    </a>
                                                </div>
                                            @else
                                                <a @disabled(true) class="btn dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                                                        <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
                                                    </svg>
                                                    Action
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-end" @disabled(true)>
                                                    <a href="{{ route('employee-ongoing-travel', ['id' => $item->id ]) }}" class="dropdown-item text-primary">
